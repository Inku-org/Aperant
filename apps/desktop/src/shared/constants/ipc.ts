...
export const IPC_CHANNELS = {
  ...
  PROVIDER_ACCOUNTS_SET_CROSS_PROVIDER_QUEUE_ORDER:
    "provider-accounts:set-cross-provider-queue-order",
  ...
  LINEAR_GET_ISSUE_COMMENTS: "linear:getIssueComments",
  LINEAR_IMPORT_ISSUES: "linear:importIssues",
  LINEAR_CHECK_CONNECTION: "linear:checkConnection",
  LINEAR_INVESTIGATE_ISSUE: "linear:investigateIssue",
  LINEAR_INVESTIGATION_PROGRESS: "linear:investigationProgress",
  LINEAR_INVESTIGATION_COMPLETE: "linear:investigationComplete",
  ...
  GITHUB_PR_NOTIFY_EXTERNAL_REVIEW_COMPLETE:
    "github:pr:notifyExternalReviewComplete",
